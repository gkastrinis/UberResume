...
%\newcommand{\dual}[2]{\tl{#1}} % English
%\newcommand{\dual}[2]{#2} % Greek
...
\dual
{{\bf Doctor of Philosophy -- PhD,} Static Program Analysis \hfill {2012 -- 2020}}
{{\bf Διδακτορικό -- \tl{PhD},} Στατική Ανάλυση Προγραμμάτων \hfill {2012 -- 2020}} \\
\diFull \\
...
\dual
{Thesis: \emph{Explorations in Static Pointer Analysis: Adaptive Scalability and Strong Guarantees}}
{Διατριβή: \emph{Εξερευνώντας τον χώρο της Στατικής Ανάλυσης Δεικτών: Κλιμάκωση και Ισχυρές Εγγυήσεις}}
...
\begin{rSection}{\dual{Activities}{Δραστηριοτητες}}
  {\bf\dual{Teaching Assistant}{Υποστήριξη Μαθήματος}} \hfill {2009 -- \dual{2019}{2019}} \\
